...
public record NewsletterSubscription(
    ...
    public NewsletterSubscription confirmRegistration() {
        return new NewsletterSubscription(id, name, email, newsletter, registrationDate, SubscriptionStatus.CONFIRMED);
    }

    public NewsletterSubscription abortRegistration() {
        return new NewsletterSubscription(id, name, email, newsletter, registrationDate, SubscriptionStatus.ABORTED);
    }
}
