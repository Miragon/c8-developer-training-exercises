# Exercise 2: Outbox and Idempotency Patterns (Kotlin Version)

Learn to implement distributed transaction patterns with Camunda 8 (Zeebe) using Kotlin.

> **Note**: This is the Kotlin version. A Java version is available at `exercises/exercise-2-outbox-java`.
