# 🧪 Exercise 1: BPMN Testing (Kotlin)

Learn to test BPMN processes with Camunda 8 using Kotlin.

> 💡 **Java version available**: `exercises/exercise-1-testing-java`

## 🎯 Your Mission

Implement 6 test methods in `BikeSubscriptionProcessTest.kt` using the completed `NewsletterSubscriptionProcessTest.kt` as reference.
...
- Check `NewsletterSubscriptionProcessTest.kt` for working examples
