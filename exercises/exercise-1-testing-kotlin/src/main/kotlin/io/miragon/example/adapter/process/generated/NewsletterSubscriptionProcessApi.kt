...
object NewsletterSubscriptionProcessApi {
  ...
  object Elements {
    ...
    val SUB_PROCESS_CONFIRM_SUBSCRIPTION: ElementId =
        ElementId("SubProcess_ConfirmSubscription")
  ...
  object Flows {
    ...
    val FLOW_09_CUVZP: BpmnFlow = BpmnFlow(
          id = "Flow_09cuvzp",
          sourceRef = "SubProcess_ConfirmSubscription",
    ...
    val FLOW_1_CSFYYZ: BpmnFlow = BpmnFlow(
          ...
          targetRef = "SubProcess_ConfirmSubscription",
        )
  ...
  object Relations {
    ...
    val ACTIVITY_SEND_WELCOME_MAIL: BpmnRelations = BpmnRelations(
          ...
          previousElements = listOf("SubProcess_ConfirmSubscription"),
    ...
    val START_EVENT_SUBMIT_REGISTRATION_FORM: BpmnRelations = BpmnRelations(
          ...
          previousElements = emptyList(),
          followingElements = listOf("SubProcess_ConfirmSubscription"),
          parentId = null,
          attachedToRef = null,
          attachedElements = emptyList(),
        )
